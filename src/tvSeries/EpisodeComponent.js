                ...
                <>
                    <Row >
                        ...
                        <Col xs={12} md={7} style={{marginTop:"10px"}}>
                            ...
                            <Row>
                                <Col xs={8} sm={5}>
                                    {episodeData.vote_average && <h5 className={styles.font_manager} style={{color:"goldenrod"}}><i className="fa-solid fa-star" />&nbsp;{episodeData.vote_average}&nbsp;&nbsp;({episodeData.vote_count} votes)</h5>}
                                </Col>
                                <Col xs={4} sm={4}>
